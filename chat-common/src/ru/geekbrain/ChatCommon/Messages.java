package ru.geekbrain.ChatCommon;



public class Messages {
    public static final String DELIMITER = "►";   //Alt + 16
    ...
    //-
    public static final String USER_RENAME = "/rename";

    public static String getUserRename(String msg) {
        return USER_RENAME + DELIMITER + msg;
    }
    //-
